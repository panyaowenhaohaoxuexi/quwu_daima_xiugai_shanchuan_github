...
import numpy as np
from torch.autograd import Variable # 从代码库 A (SSIM.py) 导入
...
def create_window(window_size, channel=1):
    ...
    # 修改：使用 Variable 以匹配代码库 A 的风格 (尽管在新版 PyTorch 中非必需)
...
def ssim(img1, img2, window_size=11, window=None, size_average=True, full=False, val_range=None):
    ...
    padd = 0 # 调整 padding 以匹配 mssim.py
